...
namespace Space_Cat_v3.Commands.Modules
{
    ...
    public sealed class MusicModule : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        {
            var player = await GetPlayerAsync().ConfigureAwait(true);
            ...
            await player.DisconnectAsync().ConfigureAwait(true);
            await RespondAsync("Disconnected.").ConfigureAwait(true);
        }
        ...
        {
            await DeferAsync().ConfigureAwait(true);

            var player = await GetPlayerAsync(connectToVoiceChannel: true).ConfigureAwait(true);
